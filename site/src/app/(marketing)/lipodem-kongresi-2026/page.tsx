...
export default function LipodemKongresi2026Page() {
  return (
    <article>
      {/* HERO */}
      <section className="bg-gradient-to-br from-teal-50 via-purple-50 to-orange-50 py-12 md:py-20">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          {/* Etkinlik Rozeti */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-600/10 border border-teal-200 mb-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-teal-600 text-white px-7 py-3 rounded-lg font-semibold hover:bg-teal-700 transition-colors"
            >
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {kongreDetaylari.map((detay) => (
              ...
              >
                <detay.icon className="w-6 h-6 text-teal-600 mx-auto mb-3" />
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="flex items-center gap-3 mb-6">
            <Mic2 className="w-6 h-6 text-teal-600" />
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="bg-gradient-to-br from-teal-600 to-teal-700 rounded-xl p-8 md:p-10 text-white">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-white text-teal-700 px-6 py-3 rounded-lg font-semibold hover:bg-teal-50 transition-colors"
                  >
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              >
                <item.ikon className="w-6 h-6 text-teal-600 mb-2" />
