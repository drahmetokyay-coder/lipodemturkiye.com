      ...
      <section className="bg-gradient-to-br from-teal-50 via-purple-50 to-orange-50 py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link
              href="/klinikler"
              className="inline-flex items-center gap-2 bg-white text-teal-600 border border-teal-200 px-7 py-3 rounded-lg font-semibold hover:bg-teal-50 transition-colors"
            >
              Klinik Bul
              <ArrowRight className="w-5 h-5" />
            </Link>
            ...
            {hangiDoktor.map((doktor) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <div className="bg-teal-50 rounded-lg px-3 py-2 text-sm">
                      <span className="font-semibold text-teal-700">
                        İpucu:{" "}
                      </span>
                      <span className="text-teal-600">{doktor.ipucu}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {ilBazliFiyatlar.map((il) => (
              ...
              >
                ...
                <div className="md:w-1/4">
                  <span className="text-teal-600 font-bold">{il.aralik}</span>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="mt-6 bg-teal-50 rounded-xl p-6 border border-teal-200">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-teal-700">
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-teal-50 via-purple-50 to-orange-50">
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/araclar/semptom-testi"
              className="inline-flex items-center justify-center gap-2 bg-teal-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-teal-700 transition-colors shadow-lg shadow-teal-600/20"
            >
            ...
            <Link
              href="/klinikler"
              className="inline-flex items-center justify-center gap-2 bg-white text-teal-600 border-2 border-teal-200 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-teal-50 transition-colors"
            >
              Klinik / Doktor Bul
              <ArrowRight className="w-5 h-5" />
            </Link>
