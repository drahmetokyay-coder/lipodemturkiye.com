                ...
                <div className="space-y-3">
                  {sosyalMedya.map((sm) => (
                    <a
                      ...
                      className="flex items-center gap-3 text-stone-600 hover:text-teal-600 transition-colors group"
                    >
                      <sm.icon className="w-5 h-5 text-stone-400 group-hover:text-teal-600 transition-colors" />
                      <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl p-8 border border-stone-200">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-teal-600 text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-teal-700 transition-colors"
              >
