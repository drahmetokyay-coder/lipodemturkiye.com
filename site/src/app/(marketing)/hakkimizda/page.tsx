      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#E8F5F0] rounded-xl p-8 border border-[#E8F5F0]">
            ...
            <div className="bg-[#E8F5F0] rounded-xl p-8 border border-[#E8F5F0]">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-lg bg-[#E8F5F0] flex items-center justify-center">
                  <Eye className="w-5 h-5 text-[#1A6B5A]" />
                </div>
                <h2 className="text-xl font-bold text-stone-800">
                  Vizyonumuz
                </h2>
            ...
            <ul className="space-y-3">
              {kaynaklar.map((kaynak) => (
                <li key={kaynak} className="flex items-start gap-3">
                  <BookOpen className="w-5 h-5 text-[#1A6B5A] mt-0.5 shrink-0" />
          ...
          <div className="bg-[#1A6B5A] rounded-xl p-8 text-white">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#E8F5F0] leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {istatistikler.map((stat) => (
              ...
              >
                <p className="text-2xl md:text-3xl font-extrabold text-[#1A6B5A]">
                  {stat.rakam}
                </p>
