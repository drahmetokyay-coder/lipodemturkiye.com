      ...
      <div className={styles.wrap} style={accentVars}>
        <div className={styles.introCard}>
          ...
          <div className={styles.introIcon}>
            <Activity className="w-9 h-9" style={{ color: ACCENT }} />
          </div>
          <h2 className={styles.introTitle}>Lipödem Yaşam Kalitesi</h2>
          <p className={styles.introMeta}>14 soru · yaklaşık 3 dakika</p>
          <p className={styles.introDesc}>Lipödemin günlük yaşamınıza, hareketinize ve ruh halinize etkisini değerlendirir.</p>
          <button
