import type { Question } from "@/data/tests/lipodem-lenfodem-ayirici-tani";
...
const ACCENT = "#6B7B99";
const ACCENT_SOFT = "#EEF1F7";
const ACCENT_BORDER = "rgba(107,123,153,0.30)";

export function DifferentialQuestion({ question, selectedScore, onAnswer }: Props) {
  return (
    <div>
      <p
