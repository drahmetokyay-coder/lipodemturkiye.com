...
const ACCENT = "#2D8B73";
const ACCENT_DARK = "#236E5C";
const ACCENT_BG = "#E6F4EE";
      ...
      <div className={styles.wrap} style={accentVars}>
        <div className={styles.introCard}>
          ...
          <div className={styles.introIcon}>
            <Dumbbell className="w-9 h-9" style={{ color: ACCENT }} />
          </div>
          <h2 className={styles.introTitle}>Egzersiz Tolerans Testi</h2>
          <p className={styles.introMeta}>8 soru · yaklaşık 2 dakika</p>
          <p className={styles.introDesc}>Fiziksel aktivite toleransınızı ve size uygun egzersiz yoğunluğunu değerlendirir.</p>
          <button
